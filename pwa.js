...
const cacheName = 'Fxit10MitchellLeon-2020-10-30 15:59:42.100634'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fxit10MitchellLeon'.length) === 'Fxit10MitchellLeon') {
